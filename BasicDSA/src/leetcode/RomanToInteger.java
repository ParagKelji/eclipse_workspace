...
public class RomanToInteger {
	...
	public int romanToInt(String s) {
		...
		for ( int i = strLen - 1; i >= 0; i--) {
			...
			System.out.println("Curr Literal: " + literal);
			String prevLiteral = (i - 1) >= 0 ? s.substring(i - 1, i) : "";
			System.out.println("Prev Literal: " + prevLiteral);
			String romanDigit = prevLiteral + literal;
			System.out.println("Roman Digit: " + romanDigit);
			Integer intDigit = romanNumDictionary.get(romanDigit);
			System.out.println("Int Digit: " + intDigit);
			if ( intDigit != null && intDigit > 0 ) {
				intNum += romanNumDictionary.get(romanDigit);
				i--;
			} else {
				intNum += romanNumDictionary.get(literal);
			}
		}
		return intNum;
    }
	...
	public static void main(String[] args) {
		...
		String s1 = "LVIII";
		String s2 = "I";
		int integerVal = integer.romanToInt(s2);
		System.out.println("Value of s is : " + integerVal);
	}
